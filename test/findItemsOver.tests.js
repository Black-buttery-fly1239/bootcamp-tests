describe('findItemsOver' , function(){
    it('should take a list of object each with a name and qty attribute and also a second parameter which is a threshold for the quantity of items available and return product that have a quantity higher than threshold ' , function(){
